...
import { getReservationsParClient, payerLeReste, rembourserReservation, annulerReservation } from "api/reservationApi";
...
export default function MesReservations() {
  ...
  const chargerReservations = async () => {
    setLoading(true);
    try {
      const data = await getReservationsParClient(userId);
